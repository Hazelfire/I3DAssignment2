...
void create_terrain() {
  ...
  // cars
  Scene::add(std::make_shared<Car>(v3d(-6, 0, 3)), tag::death);
  Scene::add(std::make_shared<Car>(v3d(0, 0, 5)), tag::death);
  Scene::add(std::make_shared<Car>(v3d(6, 0, 7)), tag::death);
  ...
  Scene::add(std::make_shared<GameObject>(std::make_shared<Tute_Water>(waterMaterial, v3d(0, -2, 15), v3d(10, 0.5, 5))), tag::death);
  ...
  Scene::add(std::make_shared<Log>(v3d(-6, -0.5, 13), texture), tag::log);
  Scene::add(std::make_shared<Log>(v3d(0, -0.5, 15), texture), tag::log);
  Scene::add(std::make_shared<Log>(v3d(6, -0.5, 17), texture), tag::log);
