...
Colour red(1, 0, 0, 1);
Car::Car(v3d position): GameObject(std::make_shared<Cube>(Material(1, red, red, red), v3d::zero, v3d(2, 1, 1)), std::make_shared<Cube>(Material(1, red, red, red), v3d::zero, v3d(2, 1, 1))) {
