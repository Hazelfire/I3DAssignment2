...
Log::Log(v3d position, GLuint texture, double speed): GameObject(new Cylinder(Material(0.6, brown*0.1, brown, brown, texture),v3d::zero, 0.5, 2 ), new Cylinder(Material(0.6, brown*0.1, brown, brown, texture),v3d::zero, 0.5, 2 )), logSpeed(speed) {
